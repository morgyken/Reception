        ...
        <div class="insured form-group {{ $errors->has('insured') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                <label class="radio-inline">
                    <input type="radio" value="0" name="insured" id="h_schemes" checked /> No</label>
                <label class="radio-inline">
        ...
        <div id="wrapper1">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('principal_relationship') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('principal_relationship1',config('system.relationship'), null, ['class' => 'form-control', 'placeholder' => 'Choose...']) !!}
                    </div>
                </div>
            </div>
        </div>
